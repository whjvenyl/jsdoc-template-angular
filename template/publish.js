        ...
        for (var groupName in groups) {
            ...
            groups[groupName].forEach(function(c) {
                        if ( !hasOwnProp.call(seen, c.longname) ) {
                            ...
                            classNav += '<li>' + linkto(c.longname, iconPrefix + c.name)+'</li>';
                        }
                        seen[c.longname] = true;
                    });

                    if (classNav !== '') {
                        nav += '<div class="well well-small"><ul class="nav nav-list"><li class="nav-header">' + groupName + '</li>';
                        nav += classNav;
                        nav += '</ul></div>';
                    }
        }
    ...
    if (members.globals.length) {
        ...
        members.globals.forEach(function(g) {
            if ( g.kind !== 'typedef' && !hasOwnProp.call(seen, g.longname) ) {
                globalNav += '<li>'+linkto(g.longname, '<i class="icon-globe" style="color: black;"></i> ' + g.name)+'</li>';
            }
